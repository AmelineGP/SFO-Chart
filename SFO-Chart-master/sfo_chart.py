...
def chartDefinition(airspaces,navaids,points,routesegments,routes,runwaydirections,runwaycentrelinepoints,chartIn,chartConf):
    elements=[]
    ...
    elements.append(airspaceForChart)
    elements.append(navaidForChart)
    elements.append(designatedPointForChart)
    elements.append(routesegmentForChart)
    elements.append(runwaycentrelinepointForChart)
...
#########GLOBAL VARIABLE########################################
AIXM_NAMESPACE={'aixm-message':'http://www.aixm.aero/schema/5.1/message','aixm':"http://www.aixm.aero/schema/5.1",'gml':"http://www.opengis.net/gml/3.2",'xlink':"http://www.w3.org/1999/xlink",'cae':"http://www.comsoft.aero/cadas-aimdb/extension"}
ROUTE_COLOR='#3D5B74'
RWYCENTRELINEPTROLE=["THR","DISPTHR"]
...
TWR_APP['POINT']=[{"type":"ICAO","name":''},{"type":"TERMINAL","name":''},{"type":"OTHER:VFR_REP","name":'','color':"#67E175"}]#designated point to be displayed. '' means all
...
for chartdef in CHART_LIST:
    ...
    chartDefinition(airspaces,navaids,points,routesegments,routes,runwaydirections,runwaycentrelinepoints,chartdef,sfolayer)
    print('\n')
